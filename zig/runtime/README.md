...
This walkthrough follows the two English Whisper models supported by this
runtime. Each stage starts with its underlying idea, then shows what actually
happens in **Base.en** and **Small.en**.
...
*Source:* [model_specification.zig](model_specification.zig),
[model.zig](model.zig), [runtime.zig](runtime.zig).
...
*Source:* [log_mel.zig](log_mel.zig).
...
*Source:* [encoder.zig](encoder.zig),
[packed_model_image.zig](packed_model_image.zig) for convolution tensor shapes.
...
*Source:* [normalization.zig](normalization.zig), [encoder.zig](encoder.zig).
...
*Source:* [attention.zig](attention.zig), [encoder.zig](encoder.zig),
[model.zig](model.zig) for the learned projection tensors.
...
*Source:* [encoder.zig](encoder.zig), [linear.zig](linear.zig).
...
*Source:* [decoder.zig](decoder.zig), [attention.zig](attention.zig).
...
*Source:* [decoder.zig](decoder.zig), [runtime.zig](runtime.zig).
...
change the explanation. The model specification remains the source of truth
for architecture dimensions.

*Source:* [ctranslate2_weights.zig](ctranslate2_weights.zig),
[vnni_weight.zig](vnni_weight.zig), [packed_model_image.zig](packed_model_image.zig),
[memory_layout.zig](memory_layout.zig), [executor.zig](executor.zig).
